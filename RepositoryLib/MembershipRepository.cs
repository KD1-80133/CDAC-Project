...
namespace RepositoryLib
{
    public class MembershipRepository : IMembershipRepository
    {
        ...
        {
            string connctionDetails = @"Data Source=(LocalDB)\MSSQLLocalDB;Initial Catalog=Logger;Integrated Security=True";
